  ...
  return (
		...
		<div className="relative">
			<Image
				...
				priority
				// className="-translate-y-80"
				className="w-full h-full object-cover -translate-y-80"
			/>
			<div className="absolute top-0 left-0 w-full h-full flex items-center justify-center lg:-translate-y-60">
				<div className="flex flex-col items-center">
					<div>
						<h2 className=" text-5xl font-extrabold text-primary">
							Nos especializamos en
